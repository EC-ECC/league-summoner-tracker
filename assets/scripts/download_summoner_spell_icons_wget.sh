...
SOURCE="https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/data/spells/icons2d/"
...
wget -r -np -nd -P "${SCRIPT_DIR}/../summoner-spells/icons/" -N -R "index.html*" ${SOURCE}
