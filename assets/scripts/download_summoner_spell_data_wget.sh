...
SOURCE="https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/summoner-spells.json"
...
wget -r -np -nd -P "${SCRIPT_DIR}/../summoner-spells/data/" -N -R "index.html*" ${SOURCE}
