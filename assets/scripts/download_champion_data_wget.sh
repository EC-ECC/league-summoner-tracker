...
SOURCE="https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/champions/"
...
wget -r -np -nd -P "${SCRIPT_DIR}/../champions/data/" -N -R "index.html*" ${SOURCE}
